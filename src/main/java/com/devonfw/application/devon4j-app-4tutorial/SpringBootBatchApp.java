package com.devonfw.application.devon4j-app-4tutorial;
...
@EntityScan(basePackages = { "com.devonfw.application.devon4j-app-4tutorial" }, basePackageClasses = { AdvancedRevisionEntity.class })
